...
- (NSArray *)queryChatRoom4s {
    ...
    if ([self.db open]) {
        ...
        while ([rs next]) {
            ...
            chatroom4.isLikeUID1 =[numberFormatter stringFromNumber: [rs stringForColumn:@"isLikeUID1"]];
            chatroom4.isLikeUID2 = [numberFormatter stringFromNumber:[rs stringForColumn:@"isLikeUID2"]];
            chatroom4.isLikeUID3 = [numberFormatter stringFromNumber:[rs stringForColumn:@"isLikeUID3"]];
            chatroom4.isLikeUID4 = [numberFormatter stringFromNumber:[rs stringForColumn:@"isLikeUID4"]];
            chatroom4.subGID1 = [rs stringForColumn:@"subGID1"];
            chatroom4.subGID2 = [rs stringForColumn:@"subGID2"];
            chatroom4.systemTimeNumber = [rs stringForColumn:@"systemTimeNumber"];
...
- (NSMutableArray *)getTenLocalChatRoom4 {
    ...
    if ([self.db open]) {
        ...
        while ([rs next]) {
            ...
            chatroom4.UID3 = [rs stringForColumn:@"UID3"];
            chatroom4.UID4 = [rs stringForColumn:@"UID4"];
            chatroom4.isLikeUID1 = [rs stringForColumn:@"isLikeUID1"];
            chatroom4.isLikeUID2 = [rs stringForColumn:@"isLikeUID2"];
            chatroom4.isLikeUID3 = [rs stringForColumn:@"isLikeUID3"];
            chatroom4.isLikeUID4 = [rs stringForColumn:@"isLikeUID4"];
            chatroom4.subGID1 = [rs stringForColumn:@"subGID1"];
            chatroom4.subGID2 = [rs stringForColumn:@"subGID2"];
            chatroom4.systemTimeNumber = [rs stringForColumn:@"systemTimeNumber"];
